...
import {  fetchGithubUserFulfilled    } from '../actions/GithubUser';
import {  fetchGithubUserReposFulfilled    } from '../actions/GithubUserRepos';
...
export const fetchGithubUserEpic = (action$ ) => {
    return action$.pipe(
...
export const fetchGithubUserReposEpic = (action$) => {
    return action$.pipe(
