...
export function mapDispatchToProps(dispatch) {
    return {
        ...
        fetchGithubUser: (githubUserName ) => dispatch(githubUseractions.fetchGithubUser(githubUserName)),
        ...
        fetchGithubUserRepos: (githubUserName) => dispatch(githubUserRepoactions.fetchGithubUserRepos(githubUserName))
    };
}
